        ...
        public override void OnRender(IGraphics graphics)
        {
            ...
            if (context.picPayTable.Visible)
            {
                for (int i = 0; i < (Definitions.iconIndexMax-1); i++)
                {
                    ...
                    graphics.DrawText(154 + i * 260, 310, amount.ToString("C"), Color.White, context.fntPaytablePrizes, GuiItem.Align.XCenter);
                }
                //2 more for cherries
                {
                    ...
                    graphics.DrawText(624, 532, amount.ToString("C"), Color.White, context.fntPaytablePrizes, GuiItem.Align.XCenter);
                    ...
                    graphics.DrawText(376, 532, amount.ToString("C"), Color.White, context.fntPaytablePrizes, GuiItem.Align.XCenter);
                    ...
                    graphics.DrawText(126, 532, amount.ToString("C"), Color.White, context.fntPaytablePrizes, GuiItem.Align.XCenter);
                }

                for (int i = 0; i < Definitions.freeTabsPayTable.Length; i++)
                {
                    int ft = Definitions.freeTabsPayTable[i].FreeTabs;
                    graphics.DrawText(840+(i*120), 525, ft.ToString(), Color.White, context.fntPaytablePrizes, GuiItem.Align.XCenter);
                }
            }
        }
